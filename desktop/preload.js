...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  openGoogleAccountLogin: () => ipcRenderer.invoke('google-account-open-login'),
  clearGoogleAccountLogin: () => ipcRenderer.invoke('google-account-clear-login'),
  openSpotifyAccountLogin: () => ipcRenderer.invoke('spotify-account-open-login'),
  clearSpotifyAccountLogin: () => ipcRenderer.invoke('spotify-account-clear-login'),
  openSpotifyOAuth: (payload) => ipcRenderer.invoke('spotify-oauth-open', payload || {}),
